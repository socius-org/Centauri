<div align="center">
  <img src="assets/repo_hero/github/llama-centaur-xb.png" alt="Llama-Centaur" width="820">
...
Meta **Llama 3.x** base models fine-tuned on Psych-101 to predict human choices — reproducing the original Centaur methodology across three scales.
...
| **8B** | `unsloth/Llama-3.1-8B` |

## Train

```bash
# a single cell (run from the repo root)
python llama-centaur/train_centaur.py --size 1B --lora_rank 16 --wandb

# the whole family sweep (rank sweep + dataset-size ablation)
python schedule_training_runs.py --family llama
```
...
`socius/Llama-Centaur-<size>-LoRA-r<rank>[-f<fraction>]`.
