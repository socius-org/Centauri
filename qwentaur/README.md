<div align="center">
  <img src="assets/repo_hero/gtihub/qwentaur-xb.png" alt="Qwentaur" width="820">
...
Alibaba **Qwen3** base models fine-tuned on Psych-101 — the family's widest scale ladder, from 0.6B to 14B.
...
python schedule_training_runs.py --family qwen
```
...
`socius/Qwentaur-<size>-LoRA-r<rank>[-f<fraction>]`.

## License

Released under the MIT License. Fine-tuned model weights inherit the license of the Qwen3 base models.
