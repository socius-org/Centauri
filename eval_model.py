#!/usr/bin/env python3
"""
Evaluate models on Psych-101 test set.
Supports both LoRA/QLoRA adapters (via Unsloth) and merged HuggingFace models (via transformers).
...
- Both Llama and Qwen3 model families
...
# (e.g., tasks with responses such as <<[1, 2]>> or <<48.0>> or <<DON'T REMEMBER>>)
...
def evaluate(
    ...
    """
    Evaluate a fine-tuned model on Psych-101 test set.
    ...
    # Load dataset
    # ============================================
    print("\nLoading Psych-101-test dataset...")
        ...
        for i, task_name in enumerate(TASK_NAMES):
            ...
            if is_variable_length:
                ...
                training_args = SFTConfig(
                    ...
                    dataset_text_field="text",           # Column name in the Psych-101 dataset
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate fine-tuned adapter on Psych-101 test set",
...
Examples:
  ...
  python eval_model.py --model socius/Qwentaur-8B
